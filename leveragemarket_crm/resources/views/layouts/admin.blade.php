...
<html lang="en">
    <head>
        ...
        <title>{{ $settings['admin_title'] }} - Admin Portal</title>
        <link rel="icon" href="{{ asset($settings['favicon']) }}">
        <link rel="preconnect" href="https://fonts.googleapis.com/">
        <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin="">
        <link href="/admin_assets/assets/admin_files/css2.css" rel="stylesheet">
        <link rel="stylesheet" href="/admin_assets/assets/admin_files/index-9805cd58.css?v=1">
        ...
        <style type="text/css">
            ...
            .vc-calendar-tools .vc-calendar-tools-container {
                height: 40px;
                font-size: 20px;
                line-height: 40px;
                color: #5e7a88;
            ...
            .vc-calendar-tools .vc-calendar-week-head .vc-calendar-week-head-container {
                width: 100%;
                display: flex;
                align-items: center;
                height: 30px;
            ...
            .vc-calendar-tools .vc-calendar-next,
            .vc-calendar-tools .vc-calendar-prev {
                cursor: pointer
            }

            .vc-calendar-tools .vc-calendar-next img,
            .vc-calendar-tools .vc-calendar-prev img {
                width: 34px;
                height: 34px
            }
            ...
            .vc-calendar-tools .vc-calendar-info .vc-calendar-month,
            .vc-calendar-tools .vc-calendar-info .vc-calendar-year {
                color: #5e7a88
            }

            .vc-calendar-tools .vc-calendar-picker {
                color: #5e7a88;
                opacity: 0;
                position: absolute;
                top: 0;
            ...
            .vc-calendar-tools .vc-calendar-picker>div {
                height: 50%
            }

            .vc-calendar-tools .vc-calendar-picker.vc-picker-show {
                -webkit-animation-name: pickerShow;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-months {
                display: flex;
                flex-wrap: wrap;
                padding: 10px 5px;
                position: relative;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-months .piecker-month-active i {
                background: #60cdff;
                color: #fff;
                border-radius: 5px;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-months:after {
                content: "";
                display: block;
                width: 94%;
                height: 1px;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-months span {
                flex-basis: 25%;
                text-align: center;
                font-size: 16px;
                position: relative
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-months span i {
                position: absolute;
                font-style: normal;
                text-align: center;
                word-break: keep-all;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-years {
                display: flex;
                flex-wrap: wrap;
                padding: 10px 5px;
                box-sizing: border-box
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-years .piecker-year-active i {
                background: #60cdff;
                color: #fff;
                border-radius: 5px;
                box-shadow: 2px 2px 2px rgba(0, 81, 118, .1)
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-years span {
                flex-basis: 20%;
                text-align: center;
                margin-bottom: 10px;
                font-size: 16px;
            ...
            .vc-calendar-tools .vc-calendar-picker .vc-calendar-years span i {
                position: absolute;
                font-style: normal;
                text-align: center;
                word-break: keep-all;
        ...
        <style type="text/css">
            ...
            .vc-calendar-swipe .swipe-wrap {
                width: 100%;
                overflow: hidden;
                position: relative
            }

            .vc-calendar-swipe .swipe-wrap .swipe-slide {
                width: 100%;
                height: 100%;
                float: left;
                position: relative
        ...
        <style type="text/css">
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row {
                overflow: hidden
            }
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day:before {
                content: "";
                padding-top: 100%;
                display: block;
                position: relative;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.selected-range-includes:after {
                content: "";
                display: block;
                position: absolute;
                width: 100%;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.selected-range-start:after {
                content: "";
                display: block;
                position: absolute;
                width: 100%;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.selected-range-start.selected-range-not-complete:after,
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.selected-range-start.vc-calendar-row-last:after {
                content: none
            }

            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day .vc-calendar-day-container {
                position: absolute;
                left: 0;
                right: 0;
                top: 0;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.vc-day-selected .vc-calendar-date {
                color: #fff
            }

            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.vc-day-selected.selected-range-includes .vc-calendar-date {
                color: #7c86a2
            }
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day .vc-calendar-date {
                width: 100%;
                display: block;
                position: absolute;
                text-align: center;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day .vc-calendar-slot-element {
                font-size: 12px;
                position: absolute;
                top: 0
            }

            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day .vc-calendar-text {
                font-size: 12px;
                position: absolute;
                bottom: 0;
                width: 100%;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.vc-calendar-disabled {
                pointer-events: none
            }
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.vc-calendar-disabled.vc-calendar-next-month-day,
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-row .vc-calendar-day.vc-calendar-disabled.vc-calendar-prev-month-day {
                pointer-events: inherit
            }

            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-rang-head .vc-calendar-rang-week-box {
                width: 100%;
                display: flex;
                align-items: center;
                height: 30px;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-rang-head .vc-calendar-rang-week-box span {
                flex: 1;
                text-align: center;
                color: #6b7897
            }

            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-rang-head .vc-calendar-rang-year-month-box {
                background: #fafafa;
                padding: 10px 0;
                color: #646464;
                text-align: center;
            ...
            .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-content {
                position: relative
            }
        ...
        <style type="text/css">
            ...
            .mpvue-calendar.mpvue-calendar-mode-week .vc-calendar-info {
                cursor: inherit
            }

            .mpvue-calendar.mpvue-calendar-mode-week .vc-calendar-timetable .vc-calendar-timetable-wrap .vc-calendar-body .vc-calendar-content .vc-calendar-month-background-text {
                font-size: 80px
            }
        </style>
        <style type="text/css">
        ...
        [data-pc-preset=preset-7] * {
            ...
            .auth-bg-cover {
				background: linear-gradient(340deg, #002A28, #009a00)
            }
